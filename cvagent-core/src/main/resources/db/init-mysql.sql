...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='CV评分结果表';
...
CREATE INDEX idx_scoring_result_cv_id ON cv_scoring_result(generated_cv_id);
CREATE INDEX idx_gen_record_result_id ON cv_generation_record(scoring_result_id);
