...
CREATE TABLE IF NOT EXISTS cv_template (
    ...
    template_content CLOB          NOT NULL COMMENT 'HTML模板内容（含{{placeholder}}占位符）',
    is_preset        BOOLEAN       NOT NULL DEFAULT FALSE COMMENT '是否为预置模板',
...
CREATE TABLE IF NOT EXISTS job_description (
    ...
    content          CLOB          NOT NULL COMMENT 'JD 正文',
...
-- 索引
CREATE INDEX IF NOT EXISTS idx_work_exp_name ON work_experience(person_name);
